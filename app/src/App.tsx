  ...
  return (
    <div className="min-h-screen pb-20">
      ...
      <div className="px-4 pt-0 pb-0 bg-white/80 backdrop-blur-md border-b border-gray-200/50 sticky top-0 z-10">
        <div className="flex items-center justify-between">
          <button onClick={() => { setShowForm(false); setShowStats(false) }} className="flex items-center gap-0.5 active:scale-95 transition-transform duration-150"><img src="/logo.png" alt="MyKrew" className="h-24 my-[-8px]" /><span className="text-lg font-semibold text-gray-500">Spend</span></button>
...
function ManagerView({ userId, userName, onLogout }: { userId: string; userName: string; onLogout: () => void }) {
  ...
  return (
    <div className="min-h-screen pb-20">
      ...
      <div className="px-4 pt-0 pb-0 bg-white/80 backdrop-blur-md border-b border-gray-200/50 sticky top-0 z-10">
        <div className="flex items-center justify-between">
          <button onClick={() => setActiveTab('home')} className="flex items-center gap-0.5 active:scale-95 transition-transform duration-150"><img src="/logo.png" alt="MyKrew" className="h-24 my-[-8px]" /><span className="text-lg font-semibold text-gray-500">Spend</span></button>
          <div className="flex items-center gap-2">
