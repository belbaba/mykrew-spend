        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          <div>
            ...
            <input
              ...
              className="w-full px-4 py-3 rounded-xl bg-white text-gray-900 border border-gray-200 focus:border-indigo-500 focus:outline-none transition-colors"
          ...
          <button
            type="submit"
            disabled={loading}
            className="w-full py-3 rounded-xl text-gray-900 font-semibold transition-all disabled:opacity-50 bg-indigo-500 hover:bg-indigo-600"
          >
      ...
      <form onSubmit={handleSubmit} className="space-y-4">
        ...
        <div>
          ...
          <input
            ...
            className="w-full px-4 py-3 rounded-xl bg-white text-gray-900 border border-gray-200 focus:border-indigo-500 focus:outline-none"
            placeholder="0.00"
            required
          />
        </div>
        ...
        <div>
          ...
          <textarea
            ...
            className="w-full px-4 py-3 rounded-xl bg-white text-gray-900 border border-gray-200 focus:border-indigo-500 focus:outline-none resize-none"
            rows={2}
        ...
        <div>
          ...
          <button
            ...
            className="w-full py-3 rounded-xl border-2 border-dashed border-gray-300 text-gray-400 hover:border-[#6366f1] hover:text-indigo-600 transition-colors"
          >
  ...
  return (
    <div className="min-h-screen min-h-screen">
      ...
      <button
        ...
        className="fixed bottom-6 right-6 w-14 h-14 rounded-full flex items-center justify-center text-gray-900 text-2xl shadow-lg shadow-indigo-500/30 active:scale-95 transition-transform bg-indigo-500 hover:bg-indigo-600"
      >
        +
      </button>
    </div>
      ...
      <div className="px-4 mb-4 flex gap-2 overflow-x-auto">
        {([
          ...
          <button
            ...
            style={activeTab === tab.key ? { backgroundColor: '#6366f1' } : { backgroundColor: '#ffffff', border: '1px solid #e5e7eb' }}
          >
            {tab.label}
          </button>
        ))}
              ...
              <div className="space-y-3 mb-4">
                <div className="grid grid-cols-3 gap-2">
                  <select
                    ...
                    className="px-3 py-2 rounded-lg bg-white text-gray-900 border border-gray-200 text-xs focus:border-indigo-500 focus:outline-none"
                  >
                ...
                <div className="flex items-center justify-between">
                  ...
                  <button
                    onClick={exportCSV}
                    className="px-3 py-1.5 rounded-lg text-xs font-medium text-indigo-600 border border-[#6366f1] hover:bg-indigo-500/10"
                  >
                    📥 Export CSV
                  </button>
                </div>
                    ...
                    <div key={exp.id} className="p-4 rounded-xl bg-white border border-gray-200 shadow-sm">
                      ...
                      {exp.status === 'approved' && (
                        <button
                          ...
                          className="mt-3 w-full py-2 rounded-lg text-xs font-medium bg-indigo-500/20 text-[#a78bfa] hover:bg-indigo-500/30"
                        >
    ...
    return (
      <div className="min-h-screen flex items-center justify-center min-h-screen">
        <div className="text-center">
          <div className="w-10 h-10 border-4 border-[#6366f1] border-t-transparent rounded-full animate-spin mx-auto" />
